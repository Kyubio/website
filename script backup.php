<script type="module">
	...
	function init() {
		...
		loader.load( 'kyubio31.glb', async function ( gltf ) 
		{
			...
			//create add ons
			var options = { "joystick": "Joystick", "buttons": "Buttons", "turnables": "Disk and Ball", "rubbers": "Rubber Dots", "scroll-clicker": "Switch and Wheel" };
			...
			document.querySelectorAll('.selection').forEach(item => 
			{
				item.addEventListener( 'change', event => 
				{
					...
					for(let i = 0 ; i < valuesLength; i++)
					{
						...
						{
							model.getObjectByName(val).visible = false;
						}							
					}
				})
			})
